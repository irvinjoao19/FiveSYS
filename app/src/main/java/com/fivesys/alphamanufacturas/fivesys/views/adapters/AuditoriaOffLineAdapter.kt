...
class AuditoriaOffLineAdapter(private var auditorias: RealmResults<Auditoria>, private var layout: Int?, var listener: ItemClickListener) : RecyclerView.Adapter<AuditoriaOffLineAdapter.ViewHolder>() {
